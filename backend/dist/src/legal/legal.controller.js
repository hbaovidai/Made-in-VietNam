...
const legal_dto_1 = require("./legal.dto");
...
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, common_1.Query)('pageKey')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], LegalController.prototype, "findActive", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], LegalController.prototype, "findAll", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('ADMIN'),
    (0, common_1.Get)(':id'),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [legal_dto_1.CreateLegalSectionDto]),
    __metadata("design:returntype", Promise)
], LegalController.prototype, "create", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('ADMIN'),
    (0, common_1.Put)(':id'),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, legal_dto_1.UpdateLegalSectionDto]),
    __metadata("design:returntype", Promise)
], LegalController.prototype, "update", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('ADMIN'),
    ...
    __metadata("design:returntype", Promise)
], LegalController.prototype, "move", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('ADMIN'),
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], LegalController.prototype, "delete", null);
exports.LegalController = LegalController = __decorate([
    (0, common_1.Controller)('legal-sections'),
