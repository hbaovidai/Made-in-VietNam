  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center bg-slate-50 px-4 py-20 text-center">
      <div className="w-24 h-24 bg-red-100 rounded-full flex items-center justify-center mb-8">
        <span className="text-4xl font-black text-viet-red">404</span>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4 w-full max-w-lg">
        <Link 
          to="/" 
          className="flex-1 flex items-center justify-center gap-2 bg-viet-red text-white px-8 py-4 font-bold hover:bg-red-700 transition-all uppercase tracking-widest text-sm shadow-lg shadow-red-500/20"
        >
      ...
      <div className="mt-16 w-full max-w-md">
        <div className="relative">
          <input 
            ...
            className="w-full px-6 py-4 bg-white border border-slate-200 rounded-sm outline-none focus:border-viet-red transition-colors"
          />
          <button className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 hover:text-viet-red">
            <Search size={20} />
          </button>
        </div>
      </div>
