...
export function BuyerSettings() {
  const settingsSections = [
    { icon: <User size={20} className="text-blue-500" />, title: "Personal Information", desc: "Update your name, bio, and profile picture." },
    ...
    { icon: <Shield size={20} className="text-red-500" />, title: "Security & Password", desc: "Change your password and enable two-factor authentication." },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="space-y-6">
            <h3 className="text-lg font-bold text-slate-900 uppercase tracking-tight flex items-center gap-2">
              <User size={20} className="text-viet-red" /> Profile Details
            </h3>
