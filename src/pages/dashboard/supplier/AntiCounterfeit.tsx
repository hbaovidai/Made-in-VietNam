    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="card p-6 border-l-4 border-l-green-500">
          ...
          <div className="text-3xl font-black text-slate-900">{qrCodes.length - compromised}</div>
          <div className="text-sm text-slate-500 font-medium mt-2">{t('valid_qrs_desc')}</div>
        </div>

        <div className="card p-6 border-l-4 border-l-red-500 bg-red-50/30">
          <div className="flex justify-between items-start mb-4">
          ...
          <div className="text-3xl font-black text-red-600">{compromised}</div>
