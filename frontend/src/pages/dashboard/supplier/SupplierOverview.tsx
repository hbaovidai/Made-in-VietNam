          ...
          <div className="bg-white border border-slate-200 shadow-sm">
            ...
            <div className="divide-y divide-slate-100">
              {recentInquiries.map((inquiry) => (
                <div key={inquiry.id} className="px-4 sm:px-6 py-4 flex items-start sm:items-center justify-between hover:bg-slate-50 transition-colors cursor-pointer group gap-3">
                  <div className="flex items-start sm:items-center gap-3 sm:gap-4 min-w-0">
                    ...
                    <div className="min-w-0">
                      <div className="text-xs sm:text-sm font-bold text-slate-800 group-hover:text-primary transition-colors truncate">{inquiry.buyer} - {inquiry.company}</div>
                      <div className="text-[10px] sm:text-xs text-slate-500 mt-1">{t('interested_in')} <span className="font-medium text-slate-700">{inquiry.product}</span></div>
                    </div>
                  </div>
                  <div className="text-right shrink-0">
                    <div className="text-[9px] sm:text-[10px] text-slate-400 font-bold uppercase tracking-widest">{inquiry.time}</div>
