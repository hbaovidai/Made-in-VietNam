...
const baseMenuItems = (t: (key: string) => string): MenuItem[] => [
  ...
  {
    icon: Shield, label: t('admin_suppliers_menu'), path: '/dashboard/admin/verification-requests',
    children: [
      ...
      { label: t('admin_add_fake_profiles'), path: '/dashboard/admin/suppliers/add-fake-profiles' },
    ],
  },
  {
