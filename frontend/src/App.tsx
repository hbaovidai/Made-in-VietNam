...
const AdminAppSupplier = React.lazy(() => import('./pages/dashboard/admin/AdminAddSupplierProfile').then(m => ({default: m.AdminAppSupplier})));
        ...
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            <Route path="/dashboard/admin" element={
              ...
              <Route path="suppliers/add-fake-profile" element={<AdminAppSupplier />} />
